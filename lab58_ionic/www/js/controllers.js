...
.controller('ListController', function($scope, $state) {
        ...
        $scope.changePageFormule = function(){
            $state.go( 'view', { id: 5 } );        
        }
})

.controller('Formulario',function($scope,$stateParams){
console.log('Formulario '+ $stateParams.id);
})
...
.controller('ViewController', function($scope, $stateParams, $ionicHistory) {
        ...
        if ( parseInt( $stateParams.id )  === 1 ) {
        ...
        } else if ( parseInt( $stateParams.id )  === 4 ){

            $scope.elements_ionic = '<h4>Grid: Evenly Spaced Columns  Id= 4</h4>' +
                                    '<div class="row">' +
        ...
        } else if ( parseInt( $stateParams.id )  === 5 ){

            $scope.elements_ionic = '<h4>Grid: Formulario </h4>' +
                                    '<div class="list">' +
                                    '<label class="item item-input item-floating-label">' +
                                    '<span class="input-label">First Name</span>' +
                                    '<input type="text" placeholder="First Name">' +
            ...
            list_element.append( $scope.elements_ionic );
        } else if ( parseInt( $stateParams.id )  === 6 ){
